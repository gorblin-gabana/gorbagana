...
pub fn parse_extension<S: BaseState + Pack>(
    ...
    match extension_type {
        ...
        ExtensionType::TokenMetadata => {
            // Handle TokenMetadata specially due to trait implementation scope issues
        ...
        ExtensionType::TokenGroup => {
            // Handle TokenGroup specially due to trait implementation scope issues
            UiExtension::UnparseableExtension
        },
        ExtensionType::TokenGroupMember => {
            // Handle TokenGroupMember specially due to trait implementation scope issues
            UiExtension::UnparseableExtension
        },
